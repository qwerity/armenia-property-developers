...
Output: write a JSON array to /Users/ksh/agents/news-agent/armenia-new-builds/scraper/.work/reputation_3/web_C.json, REWRITE it after each developer (so partial results survive), one object per developer:
...
ASSIGNMENT:
["Alliance 64", "Metta Group", "TOP BUILDINGS", "Green Hills", "ARMAT Realty", "Cascade Hills", "Eliteshin Group", "Kanach Tagh", "Lav-Sar", "SIL Capital Construction", "Coordinate (Koordinat )", "Metta Group (New Komitas)", "Retro Shin", "Moskovyan Passage (AIG / Lasker Limited / Ak And Ak Building Technologies)", "Baghramyanshin & Valex (Abovyan Hills partners)", "Luyser", "ST Service  / Mikshin", "ASR", "METTA GROUP"]
