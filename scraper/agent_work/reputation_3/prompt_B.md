...
Output: write a JSON array to /Users/ksh/agents/news-agent/armenia-new-builds/scraper/.work/reputation_3/web_B.json, REWRITE it after each developer (so partial results survive), one object per developer:
...
ASSIGNMENT:
["Comfort Build (Shinart Group)", "Rich Garden", "Rich-garden", "Prime Developers", "Brawerk  (formerly Metsn Erik )", "МЕЦН ЭРИК", "Mountain Plaza", "Khakhamyan Heritage", "Elit Project Group", "Project EVN (construction management)", "HAY DEVELOP", "Mitstart", "Midis Construction", "MIDIS CONSTRUCTION", "AAA SHIN", "Lusabac (Sunrise Residential Complex)", "Zoar", "Royal Rezidens", "Rem Group", "Bedeck", "Green Property Development"]
