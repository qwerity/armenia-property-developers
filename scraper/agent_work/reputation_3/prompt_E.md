...
Output: write a JSON array to /Users/ksh/agents/news-agent/armenia-new-builds/scraper/.work/reputation_3/web_E.json, REWRITE it after each developer (so partial results survive), one object per developer:
...
ASSIGNMENT:
["Tachat 62", "Nazaryan Grup", "Pavilion Grup", "Mets Syunik Pby", "Nyu Era", "Gmg Grup", "Hamedil Konstrakshn Grup", "Lusine-kilikia", "Nyu Taun", "Basis Grup", "ASSTROY", "Pirumyan Shin", "AMUR 21", "Horizon-95", "Tesaran Project"]
