...
Output: write a JSON array to /Users/ksh/agents/news-agent/armenia-new-builds/scraper/.work/reputation_3/web_A.json, REWRITE it after each developer (so partial results survive), one object per developer:
...
ASSIGNMENT:
["Elite Group", "Элит Груп", "Eden Park", "Haus AM", "Arm Construct", "Up Development (Sunday Towers)", "Aranna Shin", "PALLADA TSAGHKADZOR", "MyTown (Relocator Armenia)", "Care Building Services (CBS)", "Prom Group", "Navasard Shinarar", "Orient Stone", "Yerkir Real Estate Agency", "Nash Group", "Smart City"]
